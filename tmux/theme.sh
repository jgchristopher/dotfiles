...
function get_theme() {
	...
	if [[ $mode == "dark" ]]; then
		tmux set-option -g @catppuccin_prepend "#[fg=#e5c890,bg=#414559]#[fg=#303446,bg=#e5c890] #[fg=#c6d0f5,bg=#303446]"
		echo "macchiato"
	else
		tmux set-option -g @catppuccin_prepend "#[fg=#df8e1d,bg=#bcc0cc]#[fg=#dce0e8,bg=#df8e1d] #[fg=#4c4f69,bg=#dce0e8]"
		echo "latte"
	fi
}
