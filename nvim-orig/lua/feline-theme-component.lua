...
local status, lsp = pcall(require, "feline.providers.lsp")
if (not status) then return end

local lsp_severity = vim.diagnostic.severity
local b = vim.b

local _, tokyonight_colors = pcall(require, 'tokyonight.colors')
local tyc = tokyonight_colors.setup { style = 'night' }
local clrs = {
  bg = tyc.bg_statusline,
  fg = tyc.fg,
  yellow = tyc.yellow,
  cyan = tyc.cyan,
  darkblue = tyc.blue0,
  ...
  blue = tyc.blue,
  red = tyc.red,
  light_bg = tyc.bg_highlight,
  primary_blue = tyc.blue5,
}
...
local sett = {
  ...
  diffs = clrs.violet,
  extras = clrs.fg,
  curr_file = clrs.magenta,
  curr_dir = clrs.orange,
  show_modified = false,
}

local mode_colors = {
  ["n"] = { "NORMAL", clrs.violet},
  ["no"] = { "N-PENDING", clrs.violet},
  ["i"] = { "INSERT", clrs.green },
  ["ic"] = { "INSERT", clrs.green },
  ["t"] = { "TERMINAL", clrs.green },
  ["v"] = { "VISUAL", clrs.orange},
  ["V"] = { "V-LINE", clrs.orange},
  [""] = { "V-BLOCK", clrs.orange},
  ["R"] = { "REPLACE", clrs.magenta},
  ["Rv"] = { "V-REPLACE", clrs.magenta},
  ["s"] = { "SELECT", clrs.magenta},
  ["S"] = { "S-LINE", clrs.magenta},
  [""] = { "S-BLOCK", clrs.magenta},
  ["c"] = { "COMMAND", clrs.yellow},
  ["cv"] = { "COMMAND", clrs.yellow},
  ["ce"] = { "COMMAND", clrs.yellow},
  ["r"] = { "PROMPT", clrs.cyan },
  ["rm"] = { "MORE", clrs.cyan},
  ["r?"] = { "CONFIRM", clrs.violet},
  ["!"] = { "SHELL", clrs.green },
}
